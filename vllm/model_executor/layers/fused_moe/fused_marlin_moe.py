...
def fused_marlin_int2_moe(hidden_states: torch.Tensor,
                          w1: torch.Tensor,
                          w2: torch.Tensor,
                          w1_code_scale: torch.Tensor,
                          w2_code_scale: torch.Tensor,
                          w1_code_zero: torch.Tensor,
                          w2_code_zero: torch.Tensor,
                          w1_super_scale: torch.Tensor,
                          w2_super_scale: torch.Tensor,
                          gating_output: torch.Tensor,
                          topk_weights: torch.Tensor,
                          topk_ids: torch.Tensor,
                          quant_type_id: int,
    ...
    intermediate_cache1 = ops.moe_wna16_marlin_int2_gemm(
        hidden_states,
        intermediate_cache1,
        w1,
        w1_zeros,
    ...
    intermediate_cache3 = ops.moe_wna16_marlin_int2_gemm(
        intermediate_cache2,
        intermediate_cache3,
        w2,
        w2_zeros,
        ...
        size_n=K,
        size_k=N,
        use_atomic_add=use_atomic_add).view(-1, topk, K)
...
def fused_marlin_int2_moe_fake(hidden_states: torch.Tensor,
                               w1: torch.Tensor,
                               w2: torch.Tensor,
                               w1_code_scale: torch.Tensor,
                               w2_code_scale: torch.Tensor,
...
direct_register_custom_op(
    op_name="fused_marlin_int2_moe",
    op_func=fused_marlin_int2_moe,
    mutates_args=[],
    fake_impl=None,
)
