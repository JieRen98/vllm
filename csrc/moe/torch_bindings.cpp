...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, m) {
  ...
  m.def(
      "moe_wna16_marlin_int2_gemm(Tensor! a, Tensor? c_or_none,"
      "Tensor! b_q_weight, Tensor? b_zeros_or_none,"
      "Tensor! code_scales, Tensor! code_zeros, Tensor! super_scales,"
      "Tensor! workspace, Tensor sorted_token_ids,"
      "Tensor! expert_ids, Tensor! num_tokens_past_padded,"
      "Tensor! topk_weights, int moe_block_size, int top_k, "
      "bool mul_topk_weights, bool is_ep, int b_q_type_id,"
      "int size_m, int size_n, int size_k, bool use_atomic_add) -> Tensor");
  m.def(
